        ...
        <div class="container">
            ...
            <div class="text-center mb-4">
                <h5 class="subtitle-text">Enchanting cultural heritage of Banyuwangi <br>
                     featuring <strong>1.000 Statues of Gandrung Dancer</strong> and <strong>Live Performance of Gandrung Dance</strong></h5>
            </div>

            {{-- Lightbox --}}
            <div class="d-flex flex-wrap justify-content-center px-1 px-sm-5">
                <a href="{{ asset('img/dest-terakota-1.webp') }}" data-toggle="lightbox" data-footer="Tosca Lake of Ijen" data-gallery="gallery-ijen">
                    <img src="{{ asset('img/dest-terakota-1.webp') }}" class="img-gallery rounded w-100 mb-2">
                </a>
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="{{ asset('img/dest-terakota-2.webp') }}" data-toggle="lightbox" data-gallery="gallery-ijen" data-footer="Tosca Lake of Ijen" class="rounded col-4 me-1" style="max-width: 32%">
                        <img src="{{ asset('img/dest-terakota-2.webp') }}" class="img-gallery rounded w-100 mb-2">
                    </a>
                    <a href="{{ asset('img/dest-terakota-3.webp') }}" data-toggle="lightbox" data-gallery="gallery-ijen" data-footer="Tosca Lake of Ijen" class="rounded col-4 me-1" style="max-width: 32%">
                        <img src="{{ asset('img/dest-terakota-3.webp') }}" class="img-gallery rounded w-100 mb-2">
                    </a>
                    <a href="{{ asset('img/dest-terakota-4.webp') }}" data-toggle="lightbox" data-gallery="gallery-ijen" data-footer="Tosca Lake of Ijen" class="rounded col-4 me-1" style="max-width: 32%">
